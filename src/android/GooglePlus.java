...
public class GooglePlus extends CordovaPlugin implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private synchronized void buildGoogleApiClient(JSONObject clientOptions) throws JSONException {
        ...
        if (this.mGoogleSignInClient != null) this.mGoogleSignInClient.signOut();
        // nullify
        ...
        this.mGoogleSignInClient = GoogleSignIn.getClient(cordova.getActivity(),gso.build());
        ...
        this.mGoogleSignInClient.silentSignIn()
            .addOnCompleteListener(cordova.getActivity(), new OnCompleteListener<GoogleSignInAccount>() {
                ...
                public void onComplete(@NonNull Task<GoogleSignInAccount> task) {
                    Log.i(TAG, "silentSignIn complete");
                    if(task.isSuccessful()){
                        Log.i(TAG, "silentSignIn sucessful");
                        try {
                        ...
                        Log.i(TAG,exception.printStackTrace());
                        signIn();
                    }
                    /*try {
                        GoogleSignInAccount signInAccount = task.getResult(ApiException.class);
                    ...
                    /*new ResultCallback<Status>() {
                        ...
                        public void onResult(Status status) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                savedCallbackContext.error(task.getException().getMessage());
                            }
                    }
                });
        //}
